...
export default function CalligraphyPage() {
  ...
  const filteredArtworks = ARTWORKS.filter(art => art.category === 'Calligraphy');
        ...
        <Section padding="sm">
          <Container className="text-center pt-12">
            ...
            <h1 className="font-cormorant text-4xl sm:text-5xl font-light tracking-wide mb-8">
              Fine Calligraphy Collection
            </h1>
            <p className="font-sans text-sm text-secondary font-light max-w-xl mx-auto leading-relaxed mb-10">
              Browse our selection of masterfully brushed calligraphy scripts, fusing age-old Asian tradition with contemporary expressions.
            </p>
